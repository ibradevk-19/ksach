...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action=" {{route('delivry.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                    <div class="mb-3 row">
                   ...
                   <div class="mb-3 row">
                        <label for="example-text-input" class="col-md-2 col-form-label">الكود</label>
                        <div class="col-md-5">
                            <input class="form-control" placeholder="تاريخ بدء الدورة" type="date"  name="start_date" id="example-text-input">
                        </div>
                        <div class="col-md-5">
                            <input class="form-control" placeholder="تاريخ انتهاء الدورة" type="date"  name="end_date" id="example-text-input">
                        </div>
                    </div>
                    <div class="col-12">
