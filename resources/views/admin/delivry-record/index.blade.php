    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">كشف التسليم</li>
                        </ol>
                    </div>
        ...
        <div class="row my-3">
            <div class="col-6">
                ...
                <!-- <a href="{{route('delivry.create')}}"  class="btn btn-primary">دورة جديدة</a> -->
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                    <div class="row">
                    <h4 class="card-title">كشف التسليم </h4>
                    </div>

                        <button class="btn btn-danger mb-3" id="delete_all">Delete Selected</button>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#datatable").DataTable({
                ...
                serverSide: true,
                order: [[0, "desc" ]],
                ajax: "{{ route('delivry.index-record',['delivry_id' => $delivry_id]) }}",
                columns: [
