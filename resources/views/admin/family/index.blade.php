...
@section('content')
    <div class="container-fluid">
                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">العائلات</li>
                        </ol>
                    </div>
        ...
        <div class="row my-3">
            <div class="col-6">
                <a href="{{route('families.create')}}"  class="btn btn-primary">عائلة جديدة</a>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">قائمة العائلات</h4>
                        <br/>
        ...
        $(document).ready(function () {
            ...
            $("#datatable").DataTable({
                ...
                columns: [
                    ...
                    {data: 'code', name: 'code', title: 'الكود',searchable:false},
                ],
                language: {
