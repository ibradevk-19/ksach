    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">عائلة جديد</h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{route('home')}}"> الرئيسية</a></li>
                        <li class="breadcrumb-item active">عائلة جديد </li>
                    </ol>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" placeholder="الكود" type="text" value="{{old('code')}}" name="code" id="example-text-input">
                        </div>
                    </div>
                    <div class="col-12">
