...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('actors.store',['id'=>$obj->id]) }}" method="post" enctype="multipart/form-data">
                        @csrf
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-6">
                            <div class="col-md-10">
                                <input class="form-control" placeholder="رقم الجوال" type="text" value="{{ $obj->mobile_num }}" name="mobile_num" id="example-text-input">
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-10">
                                <select id="family_id" name="family_id" class="form-select">
                                    ...
                                    @foreach($families as $item)
                                      <option {{$obj->family_id == $item->id ? 'selected' : ''}} value="{{ $item->id }}">{{ $item->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
